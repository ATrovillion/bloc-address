...
describe("ContactController", () => {
    ...
    describe("#addContact()", () => {
        it("should add a single contact into the book", (done) => {
            ...
            this.book.addContact("Alice", "001-101-1010", "alice.wonderland@gmail.com")
            .then((contact) => {
    ...
    describe("search methods", () => {
        ...
        const alloy = ["Alloy Rodriguez", "111-111-1111", "allow@gerrilla-games.com"];
    
        describe("#iterativeSearch()", () => {

            it("should return null when called with an empty arrray", () => {
